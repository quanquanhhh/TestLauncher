...
namespace Foundation.Fundamental
{
    ...
    internal struct TypeNamePair : IEquatable<TypeNamePair>
    {
        ...
        public TypeNamePair(Type type, string name)
        {
            if (type == null)
            {
                throw new UnityException("Type is invalid.");
            }
        ...
        public override string ToString()
        {
            ...
            return string.IsNullOrEmpty(m_Name) ? typeName : FUtility.Text.Format("{0}.{1}", typeName, m_Name);
        }
