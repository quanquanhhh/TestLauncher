...
namespace Foundation
{
    ...
    public class LoopListView : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            mItemList = new List<LoopListViewItem>();
        ...
        public Action<LoopListView, LoopListViewItem> mOnSnapItemFinished = null;
        public Action<LoopListView, LoopListViewItem> mOnSnapNearestChanged = null;
        ...
        public void InitListView(int itemTotalCount,
            Func<LoopListView, int, LoopListViewItem> onGetItemByIndex,
        ...
        private Action<LoopListViewItem> mOnRemoveItem;
        ...
        public void SetListItemCount(int itemCount, bool resetPos = true, bool forceUpdate = false)
        {
            if (itemCount == mItemTotalCount && !forceUpdate)
            {
                return;
            }
        ...
        */
        ...
        public int GetViewOffset(out Vector2 offset)
        {
            ...
            if (mItemList.Count > 0)
            {
                ...
                if (mArrangeType == ListItemArrangeType.TopToBottom)
                {
                    ...
                    {
                        if (mContainerTrans.anchoredPosition.y + mItemList[i].CachedRectTransform.anchoredPosition.y <=
                            0)
                        {
                            offset.x = 0;
                            offset.y = mItemList[i].CachedRectTransform.anchoredPosition.y +
        ...
        public LoopListViewItem UpdateShowItem(int index)
        {
            return mItemList.Find(x => x.ItemIndex == index);
        }
    }
}