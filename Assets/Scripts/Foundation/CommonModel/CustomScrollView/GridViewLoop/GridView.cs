...
{ 
    ...
    public class GridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        class SnapData
        {
        ...
        [SerializeField] private bool mAdjustContainSize = false;
        public bool AdjustContainSize { get { return mAdjustContainSize; } set { mAdjustContainSize = value; } }
        ...
        Vector2 mEndPadding;
        System.Func<GridView,int,int,int, LoopGridViewItem> mOnGetItemByRowColumn;
        ...
        public System.Action<GridView, LoopGridViewItem> mOnSnapItemFinished = null;
        //in this callback, use CurSnapNearestItemRowColumn to get cur snaped item row column.
        public System.Action<GridView> mOnSnapNearestChanged = null;
        ...
        GridViewClick mScrollBarClickEventListener1 = null;
        GridViewClick mScrollBarClickEventListener2 = null;
        ...
        private float _mItemLocalScale = 1.0f;

        public float ItemSclae
        {
            get
            {
                return _mItemLocalScale;
            }
            set
            {
                _mItemLocalScale = value;
                ItemPadding *= value;
                ItemSize *= value;
            }
        }
        ...
        */
        public void InitGridView(int itemTotalCount, 
            System.Func<GridView,int,int,int, LoopGridViewItem> onGetItemByRowColumn, 
       ...
       //fetch or create a new item form the item pool.
        public LoopGridViewItem NewListViewItem(string itemPrefabName)
        {
            ...
            rf.localScale = Vector3.one * ItemSclae;
        ...
        */
        ...
        {
            if (mContainerTrans == null || newPadding == mItemPadding)
            {
                return;
            }
        ...
        public void UpdateContentSize()
        {
            ...
            if (mContainerTrans.rect.width != width && mColumnCount > 1)
            {
                SetHorizontalSizeKeepCenter(mContainerTrans, width);
                // mContainerTrans.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, width);
            }
        }

        private void SetHorizontalSizeKeepCenter(RectTransform rt, float targetWidth)
        {
            if (AdjustContainSize)
            {
                mContainerTrans.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, targetWidth);
                return;
            }
            else
            {
                ...
                float anchorWidth = parentWidth * (rt.anchorMax.x - rt.anchorMin.x);
                float delta = targetWidth - anchorWidth;
                float left = -delta * 0.5f;
                float right = delta * 0.5f;
        ...
        void SetScrollbarListener()
        {
            ...
            if (mScrollRect.vertical && mScrollRect.verticalScrollbar != null)
            {
                ...
                GridViewClick listener = GridViewClick.Get(curScrollBar.gameObject);
