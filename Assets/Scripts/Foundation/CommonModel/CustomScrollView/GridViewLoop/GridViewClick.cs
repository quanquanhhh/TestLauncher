...
{
    public class GridViewClick: MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
    {
        
        public static GridViewClick Get(GameObject obj)
        {
            GridViewClick listener = obj.GetComponent<GridViewClick>();
            if (listener == null)
            {
                listener = obj.AddComponent<GridViewClick>();
            }
            return listener;
        }
